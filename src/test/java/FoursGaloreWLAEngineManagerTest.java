...
public class FoursGaloreWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(FoursGaloreWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/FoursGaloreWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/FoursGaloreWLAIW/InitOutcome.xml").getDocumentElement();
